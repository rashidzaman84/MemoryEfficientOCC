...
@Plugin(name = "01 Compute Prefix Alignments - With Bounded States THESIS", parameterLabels = {"Model", "Event Data" }, 
...
public class PrefixAlignmentWithBoundedStatesPlugin {
	...
	public NullConfiguration apply(
		...
		String outputFolderPath = "D:/Research Work/latest/Streams/Rashid Prefix Alignment/Thesis/Bounded States/Results/N/With End marker/";
